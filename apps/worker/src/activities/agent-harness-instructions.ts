...
function formatMultiAgentChannelContract(): string {
  return [
    ...
    `- 如果用户要求 PPT、幻灯片、演示文稿、slides 或 presentation，必须在 envelope 的 tool_plan intent 中提出低风险工具调用 ${runtimeSlidesArtifactToolName}，不要改用网页工具或在正文里贴大段 HTML。`,
    ...
    '      "summary": "创建请求的产物",',
    '      "calls": [',
    '        { "toolName": "artifact.slides.create", "input": { "title": "标题", "fileName": "文件名", "html": "完整 HTML" } }',
    "      ]",
    "    }",
    "  ]",
    "}",
